# L1 compatibility forwarder -> L2 skill script (skill-engineering/fix-skill-entrypoints.ps1)
...
$target = Join-Path $agentsRoot "skills\share\skill-engineering\scripts\fix-skill-entrypoints.ps1"
