# L1 compatibility forwarder -> L2 skill script (skill-discovery/install-skill-from-registry.ps1)
...
$target = Join-Path $agentsRoot "skills\share\skill-discovery\scripts\install-skill-from-registry.ps1"
