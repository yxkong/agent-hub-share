# L1 compatibility forwarder -> L2 skill script (skill-engineering/check-share-skill-private-coupling.ps1)
...
$target = Join-Path $agentsRoot "skills\share\skill-engineering\scripts\check-share-skill-private-coupling.ps1"
