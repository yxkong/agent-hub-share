# L1 compatibility forwarder -> L2 skill script (skill-discovery/find-skills.ps1)
...
$target = Join-Path $agentsRoot "skills\share\skill-discovery\scripts\find-skills.ps1"
