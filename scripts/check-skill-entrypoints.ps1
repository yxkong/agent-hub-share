# L1 compatibility forwarder -> L2 skill script (skill-engineering/check-skill-entrypoints.ps1)
...
$target = Join-Path $agentsRoot "skills\share\skill-engineering\scripts\check-skill-entrypoints.ps1"
