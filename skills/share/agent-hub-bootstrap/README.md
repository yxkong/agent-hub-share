...
- **真源 vs 镜像**：hub 内 `skills/share/`、`skills/projects/<key>/` 为真源；`~/.claude/skills/` 等为用户级镜像；工作区 `.agents/skills/` 等为项目技能镜像。
...
| 场景 | 转交 |
|------|------|
| 研发全流程（节奏 + 文档/SQL） | **`rules/common/COMMON_AGENT_RULES.md` §研发全流程** |
